...
if ! ensure_policy /var/kyverno-policies/require-non-root.yaml require-non-root; then
...
if ! ensure_policy /var/kyverno-policies/require-drop-all.yaml require-drop-all; then
