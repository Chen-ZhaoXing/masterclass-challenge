...
- Multi-stage builds for small image size (<250MB). (Use Docker command to build image)
...
> 💡 If you're stuck, purchase hints from the challenge portal for guidance. Do take note that you have to use docker command to build containers and not any others like podman/kaniko
